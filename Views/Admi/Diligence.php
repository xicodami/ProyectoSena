        ...
        <main class="main col">
            <div class="row justify-content-center align-content-center text-center mb-4">
                ...
                <div class="card card body px-4 py-4">
                        <h2 class="mb-4">NEW DILIGENCE!!</h2>
                        <form action="../../DataBase/Diligence/save_task.php" method="POST">
                    ...
                    <table Id="TableJs" class="table table-sm">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="table-primary">LawyerRef</th>
                                <th scope="col" class="table-primary">ProcessesRef</th>
                                <th scope="col" class="table-primary">Actions</th>
                            </tr>
                        </thead>
                        <tbody id="rowsContact" >
                            <?php
                            $query = "SELECT * FROM diligences";
                            ...
                            while ($row = mysqli_fetch_array($result_employee)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['LawyerRef']  ?></td>
                                    <td><?php echo $row['ProcessesRef']  ?></td>
                                    <td>
                                        <a href="../../DataBase/Diligence/edit.php?id=<?php echo $row['ID'] ?>" class="btn btn-secondary">
                                            <img src="../../Imagenes/Dashboard/editar.png" alt="Edit">
                                        </a>
                                        <a href="../../DataBase/Diligence/delete_task.php?id=<?php echo $row['ID'] ?>"class="btn btn-danger">
