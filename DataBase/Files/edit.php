...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE files set ID = '$id', Name = '$Name', Company = '$Company', Type = '$Type', employeeRef = '$employeeRef', clientsRef = '$clientsRef' WHERE ID = '$id'";
    mysqli_query($conexion,$query);
    header("Location: ../../Views/Admi/Files.php");
}
?>
